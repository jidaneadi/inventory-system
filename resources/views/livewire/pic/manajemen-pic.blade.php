<div>
        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="#">PIC</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Daftar PIC</li>
                </ol>
            </nav>
            <h2 class="h4">Daftar PIC</h2>
        </div>
    </div>
    ...
    <div class="table-settings mb-4">
        <div class="row justify-content-between align-items-center">
            <div class="col-9 col-lg-8 d-md-flex">
                ...
                {{-- FILTER pic --}}
                {{-- <select wire:model="filterpic" class="form-select fmxw-200 d-none d-md-inline">
                    <option value="">Semua pic</option>
                    @foreach ($pic as $g)
                        <option value="{{ $g->id_pic }}">{{ $g->nama_pic }}</option>
                    @endforeach
                </select> --}}
            </div>

            <div class="col-3 col-lg-4 d-flex justify-content-end align-items-center">
                <a href="/pic/create" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center me-2">
                    ...
                    <span class="d-md-inline d-none">Tambah PIC</span>
                </a>
    ...
    <div class="card card-body shadow border-0 table-wrapper table-responsive">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="{{ url('pic/update/' .$p->id_pic) }}">
                                        <span class="fas fa-edit me-2"></span> Update pic
                                    </a>
                                    <button type="button" wire:click="destroy('{{ $p->id_pic }}')"
                                        class="dropdown-item text-danger d-flex align-items-center">
                                        <span class="fas fa-trash-alt me-2"></span> Delete pic
                                    </button>
                                </div>
                            </div>
                        </td>
        ...
        <div class="card-footer d-flex justify-content-between align-items-center">
            <div>
                Menampilkan {{ $pic->firstItem() }} - {{ $pic->lastItem() }} dari {{ $pic->total() }} data
            </div>
            <div>
                {{ $pic->links() }}
            </div>
