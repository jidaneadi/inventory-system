        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="#">Manajemen History Aset</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Data History Aset</li>
                </ol>
            </nav>
            <h2 class="h4">Data History Aset</h2>
        </div>
    </div>
    ...
    <div class="table-settings mb-4">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-3 col-lg-4 d-flex justify-content-end align-items-center">
                <a href="/history-aset/create" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center me-2">
                    ...
                    <span class="d-md-inline d-none">Tambah Data</span>
                </a>
    ...
    <div class="card card-body shadow border-0 table-wrapper table-responsive">
        <table class="table user-table table-hover align-items-center">
            ...
            <tbody>
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="{{ url('history-aset/update/' . $m->id_mutasi_aset) }}">
                                        <span class="fas fa-edit me-2"></span> Update Mutasi
                                    </a>

                                    <button type="button" class="dropdown-item text-danger d-flex align-items-center"
                                        wire:click="destroy('{{ $m->id_mutasi_aset }}')">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center text-muted">Belum ada data mutasi aset.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
