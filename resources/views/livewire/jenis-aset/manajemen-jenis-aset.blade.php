<div>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            ...
            <h2 class="h4">Daftar Jenis Aset</h2>
        </div>
    </div>
    ...
    <div class="table-settings mb-4">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-3 col-lg-4 d-flex justify-content-end align-items-center">
                <a href="/jenis-aset/create" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center me-2">
                    ...
                    <span class="d-md-inline d-none">Tambah Jenis Aset</span>
                </a>
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="{{ url('jenis-aset/update/' . $g->id_jenis) }}">
                                        <span class="fas fa-edit me-2"></span> Update jenis aset
                                    </a>
                                    <button type="button" wire:click="destroy('{{ $g->id_jenis }}')"
                                        class="dropdown-item text-danger d-flex align-items-center">
                                        <span class="fas fa-trash-alt me-2"></span> Delete jenis aset
                                    </button>
                                </div>
                            </div>
                        </td>
