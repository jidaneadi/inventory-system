<div>
    ...
    <div class="table-settings mb-4">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-3 col-lg-4 d-flex justify-content-end align-items-center">
                <a href="/bahan/create" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center me-2">
                    ...
                    <span class="d-md-inline d-none">Tambah Bahan</span>
                </a>
    ...
    <div class="card card-body shadow border-0 table-wrapper table-responsive">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="{{ url('bahan/update/' .$b->id_bahan) }}">
                                        <span class="fas fa-edit me-2"></span> Update divisi
                                    </a>
                                    <button type="button" wire:click="destroy('{{$b->id_bahan }}')"
        ...
        <div class="card-footer d-flex justify-content-between align-items-center">
            <div>
                Menampilkan {{ $bahan->firstItem() }} - {{ $bahan->lastItem() }} dari {{ $bahan->total() }} data
            </div>
            <div>
                {{ $bahan->links() }}
            </div>
    ...
    <script>
        ...
        function confirmDelete(event) {
            ...
            Swal.fire({
                ...
                text: "Data bahan yang dihapus tidak dapat dikembalikan!",
                icon: "warning",
