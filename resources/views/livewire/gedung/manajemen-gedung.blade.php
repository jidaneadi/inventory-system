<div>
        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Daftar Gedung</li>
                </ol>
            </nav>
            <h2 class="h4">Daftar Gedung</h2>
        </div>
    </div>
    ...
    <div class="table-settings mb-4">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-3 col-lg-4 d-flex justify-content-end align-items-center">
                <a href="/gedung/create" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center me-2">
                    ...
                    <span class="d-md-inline d-none">Tambah Gedung</span>
                </a>
    ...
    <div class="card card-body shadow border-0 table-wrapper table-responsive">
        ...
        <table class="table user-table table-hover align-items-center">
            ...
            <tbody>
                @forelse ($gedung as $g)
                    <tr wire:key="gedung-{{ $g->id_gedung }}">
                        <td>{{ $g->id_gedung }}</td>
                        <td>{{ $g->nama_gedung }}</td>
                        <td>{{ $g->alamat }}</td>
                        <td>{{ $g->updated_at }}</td>
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="{{ url('gedung/update/' . $g->id_gedung) }}">
                                        <span class="fas fa-edit me-2"></span> Update gedung
                                    </a>
                                    <button type="button" wire:click="destroy('{{ $g->id_gedung }}')"
                                        class="dropdown-item text-danger d-flex align-items-center">
                                        <span class="fas fa-trash-alt me-2"></span> Delete gedung
                                    </button>
                                </div>
                            </div>
                        </td>
        ...
        <div class="card-footer d-flex justify-content-between align-items-center">
            <div>
                Menampilkan {{ $gedung->firstItem() }} - {{ $gedung->lastItem() }} dari {{ $gedung->total() }} data
            </div>
            <div>
                {{ $gedung->links() }}
            </div>
