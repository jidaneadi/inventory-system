<div>
        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Update Divisi</li>
                </ol>
            </nav>
            <h2 class="h4">Update Divisi</h2>
        </div>
    </div>
    ...
    <div class="card card-body shadow border-0">
        <div class="row mb-4">
            <div class="col-lg-6">
                <label>Nama</label>
                <input type="text" wire:model.debounce.500ms="nama_divisi" class="form-control">
                @error('nama_divisi')
