<div>
    ...
    <div class="table-settings mb-4">
        <div class="row justify-content-between align-items-center">
            <div class="col-9 col-lg-8 d-md-flex">
                ...
                {{-- FILTER merk --}}
                {{-- <select wire:model="filtermerk" class="form-select fmxw-200 d-none d-md-inline">
                    <option value="">Semua merk</option>
                    @foreach ($merk as $g)
                        <option value="{{ $g->id_merk }}">{{ $g->nama_merk }}</option>
                    @endforeach
                </select> --}}
            </div>

            <div class="col-3 col-lg-4 d-flex justify-content-end align-items-center">
                <a href="/merk/create" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center me-2">
                    ...
                    <span class="d-md-inline d-none">Tambah Merk</span>
                </a>
    ...
    <div class="card card-body shadow border-0 table-wrapper table-responsive">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="{{ url('merk/update/' .$m->id_merk) }}">
                                        <span class="fas fa-edit me-2"></span> Update merk
                                    </a>
                                    <button type="button" wire:click="destroy('{{ $m->id_merk }}')"
                                        class="dropdown-item text-danger d-flex align-items-center">
                                        <span class="fas fa-trash-alt me-2"></span> Delete merk
                                    </button>
                                </div>
                            </div>
                        </td>
        ...
        <div class="card-footer d-flex justify-content-between align-items-center">
            <div>
                Menampilkan {{ $merk->firstItem() }} - {{ $merk->lastItem() }} dari {{ $merk->total() }} data
            </div>
            <div>
                {{ $merk->links() }}
            </div>
