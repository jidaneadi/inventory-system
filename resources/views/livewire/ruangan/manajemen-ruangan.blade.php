<div>
    ...
    <div class="table-settings mb-4">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-3 col-lg-4 d-flex justify-content-end align-items-center">
                <a href="/ruangan/create" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center me-2">
                    ...
                    <span class="d-md-inline d-none">Tambah Ruangan</span>
                </a>
    ...
    <div class="card card-body shadow border-0 table-wrapper table-responsive">
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                                    <a class="dropdown-item d-flex align-items-center"
                                        href="{{ url('ruangan/update/' . $r->id_ruang) }}">
                                        <span class="fas fa-edit me-2"></span> Update ruangan
                                    </a>
                                    <button type="button" wire:click="destroy('{{ $r->id_ruang }}')"
                                        class="dropdown-item text-danger d-flex align-items-center">
                                        <span class="fas fa-trash-alt me-2"></span> Delete ruangan
                                    </button>
                                </div>
                            </div>
                        </td>
        ...
        <div class="card-footer d-flex justify-content-between align-items-center">
            <div>
                Menampilkan {{ $ruang->firstItem() }} - {{ $ruang->lastItem() }} dari {{ $ruang->total() }} data
            </div>
            <div>
                {{ $ruang->links() }}
            </div>
