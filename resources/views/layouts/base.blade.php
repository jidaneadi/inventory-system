...
<body>
    ...
    <script>
        ...
        // Re-init script setelah Livewire update
        document.addEventListener('livewire:load', function() {
            Livewire.hook('message.processed', (message, component) => {
                // Reinit tooltip/bootstrap
                ...
                // Reinit Volt jika ada fungsi khusus
                if (typeof window.initVolt === 'function') {
                    window.initVolt();
                }
            });
        });

        // SweetAlert listener dari Livewire event
        document.addEventListener('livewire:load', function() {
